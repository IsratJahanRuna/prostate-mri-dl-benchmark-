# densenet_universal.py
"""
Universal DenseNet-121 trainer/evaluator for ADC, DWI, and T2 slice datasets
...
# ----------------------
def main():
    ap = argparse.ArgumentParser(description="Universal DenseNet-121 for ADC/DWI/T2 (patient-level outputs)")
    ...
    train_loader, val_loader, test_loader = make_loaders(ds_train, ds_val, ds_test,
    ...
    # ---- Config YAML ----
    cfg = {
        'run_name': f"densenet_{args.dataset}_seed{args.seed}",
        'seed': args.seed,
        ...
        'train': {'epochs': args.epochs, 'early_stop_patience': 0},  # tracking best by val AUC
